...
export class DashboardController {
  ...
  @ApiResponse({
    status: 200,
    description: 'Estadisticas de usuarios, roles y permisos',
  })
  getStats() {
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Dias a consultar (default 7)',
  })
  @ApiResponse({
    status: 200,
    description: 'Resumen de logins exitosos y fallidos por dia',
  })
  ...
  @ApiQuery({
    ...
    required: false,
    type: Number,
    description: 'Cantidad de registros (default 10, max 50)',
  })
